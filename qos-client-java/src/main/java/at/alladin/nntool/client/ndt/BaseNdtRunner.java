...
import at.alladin.nntool.client.helper.JSONParser;
...
public class BaseNdtRunner implements NdtRunner
{
    ...
    public static String getNdtHost()
    {
        ...
        final JSONObject obj = jParser.getURL(URI.create(at.alladin.nntool.client.helper.Config.MLAB_NS));
        try
        {
            if (obj != null)
            {
//                System.out.println(obj.toString(4));
        ...
        return at.alladin.nntool.client.helper.Config.NDT_FALLBACK_HOST;
    }
