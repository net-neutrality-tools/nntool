...
var os_functions = require(/*__dirname*/ app.getAppPath() + '/modules/' + process.platform + '.js');
    ...
    network.get_network_interfaces(function(error, interfaces) {
      ...
      if (!error && typeof interfaces !== 'undefined') {
        ...
        if (typeof interfacePrimary !== 'undefined') {
          ...
          if (typeof interfacePrimary.description !== 'undefined')
            interfaceConfiguration.description = interfacePrimary.description;
          if (typeof interfacePrimary.speed !== 'undefined') interfaceConfiguration.speed = interfacePrimary.speed;
          if (typeof interfacePrimary.mac_address !== 'undefined')
            interfaceConfiguration.mac = interfacePrimary.mac_address;
          if (typeof interfacePrimary.ipv4_address !== 'undefined')
            interfaceConfiguration.ip = interfacePrimary.ipv4_address;
          if (typeof interfacePrimary.ipv4_netmask !== 'undefined')
            interfaceConfiguration.netmask = interfacePrimary.ipv4_netmask;
          if (typeof interfacePrimary.ipv4_gateway_address !== 'undefined')
            interfaceConfiguration.gateway = interfacePrimary.ipv4_gateway_address;
          if (typeof interfacePrimary.mtu !== 'undefined') interfaceConfiguration.mtu = interfacePrimary.mtu;
          if (typeof interfacePrimary.ipv4Primary !== 'undefined')
            interfaceConfiguration.ipv4Primary = interfacePrimary.ipv4Primary;
          if (typeof interfacePrimary.ipv6Primary !== 'undefined')
            interfaceConfiguration.ipv6Primary = interfacePrimary.ipv6Primary;
        }
      } else {
...
Tool.prototype.getLocationKPIs = function() {
  ...
  navigator.geolocation.getCurrentPosition(
    getLocationKPIsCallbackInititator,
    getLocationKPIsCallbackInititator,
    options
  );
};
