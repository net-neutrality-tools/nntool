...
public class TaskConfigurationQoS extends TaskConfiguration {
	
	@Expose
	@SerializedName("measurement_parameters")
	private QoSMeasurementTypeParameters measurementParameters;
	...
	public void setMeasurementParameters(QoSMeasurementTypeParameters measurementParameters) {
