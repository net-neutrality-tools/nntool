...
public class WebsiteTestServiceImpl implements WebsiteTestService {
	...
	private final static String TAG = "WebsiteTestServiceImpl";
	...
	private Long httpNavigationStartTime = null;

	private Long httpResponseTime = null;
							...
							if (listener.onTimeoutReached(WebsiteTestServiceImpl.this)) {
								...
								WebsiteTestServiceImpl.this.handler.post(new Runnable() {											
									...
									public void run() {
										...
										listener = null;
										WebsiteTestServiceImpl.this.webView.loadUrl("about:blank");
									}
								});
							}
						}
				...
				webView.setWebViewClient(new WebViewClient() {
					...
					*/
					...
					public void onLoadResource(WebView view, String url) {
						...
						if (httpResponseTime == null && httpNavigationStartTime != null) {
							Log.i(TAG, "Start time");
							Log.i(TAG, Long.toString(httpNavigationStartTime));
							httpResponseTime = System.nanoTime() - httpNavigationStartTime;
							Log.i(TAG, "Response time");
							Log.i(TAG, Long.toString(httpResponseTime));
						}
					...
					public void onReceivedError(WebView view, int errorCode,
						...
						WebsiteTestServiceImpl.this.duration = System.nanoTime() - start;
						WebsiteTestServiceImpl.this.errorMessage.set(description);
					...
					public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
						//if a redirect is made, call it a resource as well
						resourceCount.incrementAndGet();
				...
				task.setContentRetrieverListener(new ContentRetrieverListener() {
					...
					public void onContentFinished(String htmlContent, int statusCode, String errorMessage) {
						...
						if (statusCode >= 0) {
							...
							if (WebsiteTestServiceImpl.this.httpNavigationStartTime == null) {
								WebsiteTestServiceImpl.this.httpNavigationStartTime = System.nanoTime();
							}
							...
							WebsiteTestServiceImpl.this.hasError.set(true);
							WebsiteTestServiceImpl.this.duration = System.nanoTime() - start;
							WebsiteTestServiceImpl.this.errorMessage.set(errorMessage);
