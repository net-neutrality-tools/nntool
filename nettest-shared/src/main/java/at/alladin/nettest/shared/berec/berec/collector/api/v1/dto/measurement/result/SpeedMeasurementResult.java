...
/**
 * This DTO contains the speed measurement results from the client.
 * 
 * @author alladin-IT GmbH (bp@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "This DTO contains the speed measurement results from the client.")
@JsonClassDescription("This DTO contains the speed measurement results from the client.")
public class SpeedMeasurementResult extends SubMeasurementResult {

	/**
	 * Bytes received during the speed measurement (Download).
	 */
	@io.swagger.annotations.ApiModelProperty("Bytes received during the speed measurement (Download).")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Bytes received during the speed measurement (Download) with slow-start phase.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Bytes transferred during the speed measurement (Upload).")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Bytes transferred during the speed measurement (Upload) with slow-start phase.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Duration of the RTT measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Duration of the download measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Duration of the upload measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Relative start time of the RTT measurement in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Relative start time of the download measurement in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Relative start time of the upload measurement in nanoseconds.")
...
// RttInfo
	 ...
	 * @see RttInfoDto
	 */
	@io.swagger.annotations.ApiModelProperty("Contains round trip time information measured during the measurement on the client.")
	@JsonPropertyDescription("Contains round trip time information measured during the measurement on the client.")
	@Expose
...
// SpeedMeasurementRawData
	...
	/**
	 * Contains a list of all captured byte transfers during the download speed measurement on the client.
	 */
	@io.swagger.annotations.ApiModelProperty("Contains a list of all captured byte transfers during the download speed measurement on the client.")
	@JsonPropertyDescription("Contains a list of all captured byte transfers during the download speed measurement on the client.")
	@Expose
	...
	/**
	 * Contains a list of all captured byte transfers during the upload speed measurement on the client.
	 */
	@io.swagger.annotations.ApiModelProperty("Contains a list of all captured byte transfers during the upload speed measurement on the client.")
	@JsonPropertyDescription("Contains a list of all captured byte transfers during the upload speed measurement on the client.")
	@Expose
...
// ConnectionInfo
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Contains information about the connection(s) used for the speed measurement.")
