 ...
 *
 */
@io.swagger.annotations.ApiModel(description = "Contains information about the client's OS.")
...
public class OperatingSystemInfoDto {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Operating system name (e.g. Android or iOS).")
