...
public enum LmapStateDto {
	...
	RUNNING, // The value 'running' indicates that the Action/Schedule is currently running.
	SUPPRESSED // The value 'suppressed' indicates that the Action/Schedule is currently suppressed.
}
