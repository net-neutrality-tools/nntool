...
/**
 * Cell location information from a point in time on the client.
 *
 * @author alladin-IT GmbH (bp@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "Cell location information from a point in time on the client.")
@JsonClassDescription("Cell location information from a point in time on the client.")
public class CellLocationDto {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Time and date the cell location information was captured (UTC).")
