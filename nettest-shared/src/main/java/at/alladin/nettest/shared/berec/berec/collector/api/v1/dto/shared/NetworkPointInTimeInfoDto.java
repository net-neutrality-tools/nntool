...
public class NetworkPointInTimeInfoDto {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Public IP address of the client.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Country of the client which is gathered by Geo-IP lookup.")
