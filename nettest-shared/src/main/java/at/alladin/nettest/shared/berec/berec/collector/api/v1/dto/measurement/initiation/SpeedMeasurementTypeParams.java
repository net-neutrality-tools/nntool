...
/**
 * This DTO contains speed measurement instructions for the client.
 * 
 * @author alladin-IT GmbH (bp@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "This DTO contains speed measurement instructions for the client.")
@JsonClassDescription("This DTO contains speed measurement instructions for the client.")
public class SpeedMeasurementTypeParams extends MeasurementTypeParameters {

	/**
	 * @see Durations
	 */
	@io.swagger.annotations.ApiModelProperty("Durations for each phase of the measurement.")
	 ...
	 * @see Flows
	 */
	@io.swagger.annotations.ApiModelProperty("Number of (TCP) flows for each phase of the measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Number of RTT packets that should be send in the RTT measurement.")
	@JsonPropertyDescription("Number of RTT packets that should be send in the RTT measurement.")
	@Expose
	@SerializedName("rtt_count")
	@JsonProperty("rtt_count")
	private Integer rttCount;
	
	/**
	 * URL to the measurement code. Overrides the client's implementation if set.
	 */
	@io.swagger.annotations.ApiModelProperty("URL to the measurement code. Overrides the client's implementation if set.")
	@JsonPropertyDescription("URL to the measurement code. Overrides the client's implementation if set.")
	@Expose
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The measurement server that should be used, or the first measurement server that should be requested when load balancing.")
	...
	@JsonProperty("measurement_server")
