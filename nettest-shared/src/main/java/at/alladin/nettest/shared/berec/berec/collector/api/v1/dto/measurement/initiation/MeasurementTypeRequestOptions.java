...
/**
 * Base class for sub measurement request options sent by the client.
 * 
 * @author alladin-IT GmbH (bp@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "Base class for sub measurement request options sent by the client.")
@JsonClassDescription("Base class for sub measurement request options sent by the client.")
public abstract class MeasurementTypeRequestOptions {

	/**
	 * The test counter stored on the client (how many measurement have already been executed).
	 */
	@io.swagger.annotations.ApiModelProperty("The test counter stored on the client (how many measurement have already been executed).")
	@JsonPropertyDescription("The test counter stored on the client (how many measurement have already been executed).")
	@Expose
