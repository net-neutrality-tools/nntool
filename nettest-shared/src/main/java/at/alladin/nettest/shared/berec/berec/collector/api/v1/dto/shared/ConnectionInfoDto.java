...
public class ConnectionInfoDto {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The address of the measurement server.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Port used for the communication.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Indicates if the communication with the measurement server will be encrypted.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Contains information about total bytes transferred during the speed measurement, as reported by the client's interface, if available. Only used for displaying to the client.")
	...
	private TrafficDto clientInterfaceTotalTraffic;
	 ...
	 * Only used for displaying to the client.
	 */
	@io.swagger.annotations.ApiModelProperty("Contains information about bytes transferred during the download measurement, as reported by the client's interface, if available. Only used for displaying to the client.")
	...
	private TrafficDto clientInterfaceDownloadMeasurementTraffic;
	 ...
	 * Only used for displaying to the client.
	 */
	@io.swagger.annotations.ApiModelProperty("Contains information about bytes transferred during the upload measurement, as reported by the client's interface, if available. Only used for displaying to the client.")
	...
	private TrafficDto clientInterfaceUploadMeasurementTraffic;

	/**
	 * The requested number of streams for the download measurement.
	 */
	@io.swagger.annotations.ApiModelProperty("The requested number of streams for the download measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The requested number of streams for the upload measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The actual number of streams used by the download measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The actual number of streams used by the upload measurement.")
	...
	public TrafficDto getClientInterfaceTotalTraffic() {
		return clientInterfaceTotalTraffic;
	}

	public void setClientInterfaceTotalTraffic(TrafficDto clientInterfaceTotalTraffic) {
		this.clientInterfaceTotalTraffic = clientInterfaceTotalTraffic;
	}

	public TrafficDto getClientInterfaceDownloadMeasurementTraffic() {
		return clientInterfaceDownloadMeasurementTraffic;
	}

	public void setClientInterfaceDownloadMeasurementTraffic(TrafficDto clientInterfaceDownloadMeasurementTraffic) {
		this.clientInterfaceDownloadMeasurementTraffic = clientInterfaceDownloadMeasurementTraffic;
	}

	public TrafficDto getClientInterfaceUploadMeasurementTraffic() {
		return clientInterfaceUploadMeasurementTraffic;
	}

	public void setClientInterfaceUploadMeasurementTraffic(TrafficDto clientInterfaceUploadMeasurementTraffic) {
