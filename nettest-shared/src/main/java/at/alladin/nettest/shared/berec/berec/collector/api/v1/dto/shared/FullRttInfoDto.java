...
public class FullRttInfoDto extends RttInfoDto {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Minimum (best) RTT value in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Maximum (worst) RTT value in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Average RTT value in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Median RTT value in nanoseconds.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Calculated RTT variance.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Calculated RTT standard deviation in nanoseconds.")
