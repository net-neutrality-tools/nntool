...
/**
 * This DTO class contains all speed measurement information that is sent to the client.
 * 
 * @author alladin-IT GmbH (bp@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "This DTO class contains all speed measurement information that is sent to the client.")
@JsonClassDescription("This DTO class contains all speed measurement information that is sent to the client.")
public class FullSpeedMeasurement extends FullSubMeasurement {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The calculated (average) download throughput in bits per second.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The calculated (average) upload throughput in bits per second.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The nominal measurement duration of the download measurement.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("The nominal measurement duration of the upload measurement.")
	 ...
	 * @see FullRttInfoDto
	 */
	@io.swagger.annotations.ApiModelProperty("Contains round trip time information measured during the measurement.")
