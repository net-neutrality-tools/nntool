...
public class ApiPagination<T> {
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Paginated list of objects.")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Current page number (>= 0).")
	 ...
	 * Current page size (> 0).
	 */
	@io.swagger.annotations.ApiModelProperty("Current page size (> 0).")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Total amount of pages (>= 0).")
	 ...
	 */
	@io.swagger.annotations.ApiModelProperty("Total amount of objects (>= 0).")
