...
/**
 * Contains signal information from a point in time on the client.
 * 
 * @author alladin-IT GmbH (lb@alladin.at)
 *
 */
@io.swagger.annotations.ApiModel(description = "Contains signal information from a point in time on the client.")
@JsonClassDescription("Contains signal information from a point in time on the client.")
