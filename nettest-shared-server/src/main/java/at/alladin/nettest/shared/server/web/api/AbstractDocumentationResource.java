package at.alladin.nettest.shared.server.web.api;
...
public abstract class AbstractDocumentationResource {
	...
	/**
	 * Redirects to the OpenApi specification.
	 * This request redirects the user to the OpenAPI specification at /v2/api-docs?group=<group>.
	 * 
	 * @param response
	 * @throws IOException
	 */
	 ...
	 * @return
	 */
	@io.swagger.annotations.ApiOperation(value = "Returns the json schema of the REST API DTO classes.", notes = "")
	 ...
	 * @return
	 */
	@io.swagger.annotations.ApiOperation(value = "Returns the json schema of the data model classes.", notes = "")
