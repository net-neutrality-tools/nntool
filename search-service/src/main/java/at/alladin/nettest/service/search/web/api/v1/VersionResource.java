...
public class VersionResource {
	 ...
	 * @return
	 */
	@io.swagger.annotations.ApiOperation(value = "Get the server version.", notes = "Returns the software version of the search-service.")
    ...
    public ResponseEntity<ApiResponse<VersionResponse>> getVersion() {
		...
		versionResponse.setSearchServiceVersion("0.0.0");
