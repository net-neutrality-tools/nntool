...
public class VersionResource {
	 ...
	 * @return
	 */
	@io.swagger.annotations.ApiOperation(value = "Get the server version.", notes = "Returns the software version of the result-service.")
    ...
    public ResponseEntity<ApiResponse<VersionResponse>> getVersion() {
		...
		versionResponse.setResultServiceVersion("0.0.0");
